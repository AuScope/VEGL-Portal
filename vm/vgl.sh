...
export CLOUD_STORAGE_WRAPPER_URL="https://svn.auscope.org/subversion/AuScopePortal/VHIRL-Portal/trunk/vm/cloud.sh"
...
export FILECONVERSION_URL="https://svn.auscope.org/subversion/AuScopePortal/VHIRL-Portal/trunk/vm/VHIRL_conversions.py"
