...
class vgl_common {
    ...
    package { ["wget", "subversion", "mercurial", "ftp", "bzip2", "bzip2-devel", "elfutils", "ntp", "ntpdate", "gcc", "gcc-c++", "make", "openssh", "openssh-clients", "swig", "libpng-devel", "freetype-devel", "atlas", "atlas-devel", "libffi-devel", "mlocate"]: 
        ensure => installed,
        require => Class["epel"],
    }
	...
	package { ["numpy", "unittest2", "setuptools", "distutils", "pip"]:
	    ensure => latest,
        provider => "pip",
        require => [Class["python_pip"]],
	}
